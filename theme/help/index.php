...
<html class="sb-init" lang="ru"><head>
    ...
    <title>Техническая поддержка - служба информационной помощи</title>
          ...
          <ul class="topmenumob">
			...
			<div class="container">
					<ul class="breadcrumb">
						...
						<li typeof="v:Breadcrumb"><a href="#" rel="v:url" property="v:title" title="Раздел Помощь">Помощь</a></li>
					</ul>
			</div>
	...
	<div style="height: 100%;" class="col-md-3 col-sm-3 hidden-xs hidden-sm stick_height_js">
		    <aside class="sidebar-left-help" id="sidebar-left-help">																
              <ul class="nav nav-tabs nav-stacked nav-coupon-category nav-coupon-category-left hidden-xs-block">
                 <li class="fa roadmach"><a href="/theme/help/postavshchikam.php" title="Как подать объявление"><i class="fa"></i>Поставщикам</a></li>
                 <li class="fa roadmach"><a href="/theme/help/pokupatelyam.php" title="Как найти поставщика"><i class="fa"></i>Покупателям</a></li>
                 <li class="active"><a href="/theme/help/index.php" title="Помощь"><i class="fa"></i>Помощь</a></li>			
              </ul>										
		    </aside>
    </div>
	...
	<div style="height: 100%;" class="col-md-9 col-sm-12 stick_height_js">
            <div class="row">
				<div class="cont-help-box">
					<div>
						<h1>Что делать дальше?</h1>

<p>Для поставщиков:<br>
- <a href="/theme/regpay/reg.php">Подать объявление</a>;<br>
- <a href="/theme/regpay/pay.php">Оплатить аренду объявления</a>;<br>
- <a href="/theme/help/postavshchikam/only-prioritety.php">Как поднять приоритеты? </a> или перейти на страницу <a href="/theme/regpay/pay.php"> Поднять приоритеты объявления </a>.</p><br

<p>Для покупателей:<br>
- <a href="/theme/help/pokupatelyam.php">Как найти Поставщиков</a></p><br>
						
<p>Перед размещением объявлений, внимательно прочтите <a href="/theme/help/rules.php" target="_blank">Пользовательское соглашение </a><br>
А так же перед началом работы с сервисом ознакомьтесь с <a href="/theme/help/agreements.php" target="_blank">Политикой обработки персональных данных </a>
</p>
