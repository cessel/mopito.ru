...
<html class="sb-init" lang="ru"><head>
    ...
    <title>Техническая поддержка - для Поставщика - Как разместить Горячие объявления</title>
          ...
          <ul class="topmenumob">
			...
			<div class="container">
					<ul class="breadcrumb">
						...
						<li typeof="v:Breadcrumb"><a href="#" rel="v:url" property="v:title" title="Раздел Поставщикам">Как разместить Горячие объявления</a></li>
					</ul>
			</div>
	...
	<div style="height: 100%;" class="col-md-3 col-sm-3 hidden-xs hidden-sm stick_height_js">
		    <aside class="sidebar-left-help" id="sidebar-left-help">																
              <ul class="nav nav-tabs nav-stacked nav-coupon-category nav-coupon-category-left hidden-xs-block">
                 ...
                 <li class="active"><a href="/theme/help/postavshchikam/hot-advt.php" title="Как разместить Горячие объявления"><i class="fa"></i>Как разместить Горячие объявления</a></li>
	...
	<div style="height: 100%;" class="col-md-9 col-sm-12 stick_height_js">
            <div class="row">
				<div class="cont-help-box">
					<div>
						<h1>Как разместить Горячие объявления</h1>
<p><b>«Горящие объявления»</b> - это предложение от Поставщика со скидкой на товар или услугу. Такие предложения показываются в общем списке. 
Горящие объявления выделены специальным значком и объявление выделено красной рамкой. Это делает более заметным и привлекательным блок объявления. <br><br>
Для размещения Горящего объявления, необходимо иметь статус от <b>3-х Приоритетов</b>. 
</p>
<p>Для поднятия Приоритета объявления перейдите на страницу <a href="/theme/regpay/pay.php" target="_blank">«Поднять выше»</a>, выберите услугу <b>«Приоритеты»</b>, количество приоритетов, и по выставленному счету оплатите услугу. Услуга подключиться в 00:00 час по московскому времени, и распространяется на весь текущий период действия аренды объявления.</p>
