...
<html class="sb-init" lang="ru"><head>
	...
	<title>Mopito.ru - сервис поиска поставщиков продуктов питания и напитков оптом</title>
	<meta name="description" content="Мопито.ру — сервис поиска поставщиков продуктов питания и напитков оптом: 🍷крепкий алкоголь, 🍺пиво, чай и кофе, снеки и закуски, 🐑мясо, 🐟рыба, 🍅фрукты и овощи, оборудование для торговли и бизнеса, услуги по кейтерингу, монтаж торговых помещений под ключ. Поиск по вашим критериям. Удобная система поиска и ☎️взаимодействия  с 🚚поставщиками . 📋Прайс листы на Mopito.ru. Москва, Санкт-Петербург, 🌍Россия">
	<link rel="canonical" href="https://mopito.ru/">
	...
	<noscript><link rel="stylesheet" type="text/css" href="/theme/css/noJS.css" /></noscript>
	...
	<script src="/theme/js/drop-java.js"></script><!-- fix horiz ban-->
	<script src="/theme/js/drop-java-smol.js"></script><!-- fix horiz ban-->
	<script src="/theme/js/scroladv.js"></script><!-- fix horiz ban-->
</head>
			...
			<div class="allrow">
				...
				<div class="raz-big-17 raz-mid-17 raz-mal-15">
					<p class="primary-title">
						Дарим по 3000 баллов за регистрацию компании!*
					</p>
				...
				<div class="raz-big-4 raz-mid-4 raz-mal-5">
					<a href="/theme/regpay/reg.php" target="_blank" class="btn btn-secondary">Добавить компанию
					</a>
				</div>
			</div>
		</div>
 <!-- end adv ban-->
	<div class="ui-block ui-block_border-radius-4 old-search-form old-search-form_top">
		<form action="." autocomplete="off" data-shmid="oldSearchForm">
			<h1 class="ui-title ui-title_medium_desktop old-search-form__title">Mopito.ru - сервис поиска Поставщиков продуктов питания и напитков по Москве и России</h1>
			
<!-- begin adv ban-->
			
		<div class="advert kalife-wrapper kalife-wrapper-search" >
			<div class="allrow" align="center">
				<div>
					<a href="/theme/regpay/reg.php" target="_blank" class="btn btn-secondary">Регистрация компании
					</a>
				</div>
			</div>
		</div>
 <!-- end adv ban-->			
	...
	<div class="row2livel">
	<div class="ui-block ui-block_border-radius-4 old-search-form2livel old-search-form_top2livel">
			<div class="old-search-form__wrapper">
				<noindex><p class="text-muted2livel red1">Внимание: СКОРО ЗАПУСК ПРОЕКТА! В настоящий момент идет только РЕГИСТРАЦИЯ ПРОИЗВОДИТЕЛЕЙ и ПОСТАВЩИКОВ! Не надо будет бегать по оптовикам, торговым точкам и будущим Партнерам - они Вас сами найдут! На сайте размещены тестовые объявления ТОЛЬКО для примера
				</p></noindex>
			</div>
	</div>	
					<div class="gap-small"></div>
	...
	<div class="ui-block ui-block_border-radius-4 old-search-form old-search-form_top">
		<div class="new-index-head-glow">
				<h2 class="new-index-head-text" align="center">Выберите город</h2>
		</div>
        <div class="row">
           <div class="col-xs-12">
			   <ul class="main_cities_glav list-inline">
...
<li><a href="/spb/alkogolnie/"><span class="orangtext">Санкт-Петербург</span></a></li><br>
	...
	<div class="ui-block ui-block_border-radius-4 old-search-form old-search-form_top">
		<div class="new-index-head-glow">
				<h2 class="new-index-head-text">Выбор категории</h2>
		</div>
	<div class="old-search-form__wrapper">
								<ul class="dropdown">
								   <li><a href="/msk/alkogolnie/"><span class="orangtext">Алкоголь</span></a></li>
								   <li><a href="/msk/alkogolnie/vodka_optom/"><span>Водка</span></a></li>
								   <li><a href="/msk/alkogolnie/konyak_optom/"><span>Коньяк</span></a></li>
								   <li><a href="/msk/alkogolnie/vino_optom/"><span>Вино</span></a></li>
                                   <li><a href="/msk/alkogolnie/shampanskoe_optom/"><span>Шампанское</span></a></li>
								   <li><a href="/msk/alkogolnie/pivo_optom/"><span>Пиво</span></a></li>
								   <li><a href="/msk/alkogolnie/sidr_medovuha_optom/"><span>Сидр, медовуха</span></a></li><br>
								   <li><a href="/msk/bezalkogolnie/"><span class="orangtext">Безалкоголь</span></a></li>
                                   <li><a href="/msk/bezalkogolnie/soki_optom/"><span>Соки</span></a></li>
								   <li><a href="/msk/bezalkogolnie/voda_optom/"><span>Вода</span></a></li>
								   <li><a href="/msk/bezalkogolnie/limonad_optom/"><span>Лимонад</span></a></li>
                                   <li><a href="/msk/bezalkogolnie/kvas_optom/"><span>Квас</span></a></li><br>
								   <li><a href="/msk/zakuski_sneki/zakuski_sneki_optom/"><span class="orangtext">Закуски и снеки</span></a></li><br>
                                   <li><a href="/msk/kofe_chaj/"><span class="orangtext">Чай и кофе</span></a></li>
                                   <li><a href="/msk/kofe_chaj/chaj_optom/"><span>Чай оптом</span></a></li>
								   <li><a href="/msk/kofe_chaj/kofe_optom/"><span>Кофе оптом</span></a></li><br>
                                   <li><a href="/msk/produkty_pitaniya/"><span class="orangtext">Продукты питания</span></a></li>
                                   <li><a href="/msk/produkty_pitaniya/frukty_optom/"><span>Фрукты</span></a></li>
                                   <li><a href="/msk/produkty_pitaniya/ovoshchi_optom/"><span>Овощи</span></a></li>
                                   <li><a href="/msk/produkty_pitaniya/myaso_optom/"><span>Мясо</span></a></li>
                                   <li><a href="/msk/produkty_pitaniya/ryba_optom/"><span>Рыба</span></a></li><br>
                                   <li><a href="/msk/oborudovanie/"><span class="orangtext">Оборудование для торговли</span></a></li>
                                   ...
                                   <li><a href="/msk/catering/"><span class="orangtext">Услуги Кейтеринга</span></a></li>
									<li><a href="/msk/catering/vyezdnoe_obsluzhivanie/"><span>Выездное обслуживание</span></a></li>
									<li><a href="/msk/catering/bankety/"><span>Банкеты</span></a></li>
									<li><a href="/msk/catering/organizaciya_prazdnikov/"><span>Организация праздников</span></a></li><br>
                                   <li><a href="/msk/uslugi/"><span class="orangtext">Услуги, сервис</span></a></li>
									<li><a href="/msk/uslugi/servis/"><span>Обслуживание оборудования</span></a></li>
									<li><a href="/msk/uslugi/otdelka_i_montazh/"><span>Монтаж и отделка</span></a></li><br>
								 </ul>
			</div>
...
<li><span class="blue1">Выберите поставщика в своем городе:</span></li><br><br>
<li><a href="/msk/alkogolnie/"><span class="orangtext">Москва</span></a></li>
<li><a href="/spb/alkogolnie/"><span class="orangtext">Санкт-Петербург</span></a></li><br>
