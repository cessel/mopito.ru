...
<div id="form">
  ...
  <form id="form1">
    ...
    <div id="dsl">
      ...
      <input type="text" id="id" name="id" placeholder="Вставьте ID" onBlur="inpId(Pattern(true, this, /^ID[0-9]{1,9}-[A-Za-zА-Яа-яЁё]{1,9}\s[0-9]{2}.[0-9]{2}.[0-9]{4}\sP-[A-Za-zА-Яа-яЁё0-9]{1,9}$/), this, 'dsl1')" onMouseOut="inpId(Pattern(true, this, /^ID[0-9]{1,9}-[A-Za-zА-Яа-яЁё]{1,9}\s[0-9]{2}.[0-9]{2}.[0-9]{4}\sP-[A-Za-zА-Яа-яЁё0-9]{1,9}$/), this, 'dsl1')"                value="ID1001-msk 25.12.2016 P-01">
    ...
    <div id="priorities" style="display:none;">
        ...
        <span>Сумма к оплате в размере <big></big> рублей в количестве <big></big> пр.</span>
