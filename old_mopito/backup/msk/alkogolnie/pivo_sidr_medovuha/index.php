...
$identifikator = 'pivo_sidr_medovuha_msk';
...
<html class="sb-init" lang="ru"><head>
   ...
   <title>Пиво, сидр</title>
   <meta name="description" content="Мы нашли для Вас <? echo $krepkie_count; ?> видов пива, сидра. mopito.ru - онлайн витрина для доставки алкоголя">	
   <link rel="canonical" href="http://mopito.ru/msk//alkogolnie/pivo_sidr_medovuha">
...
<div class="header-container1">																
   <div class="box-header1">															
	  ...
	  <div class="header-item1 header-dropdown1"><span id="category_current" class="categoryCurrent header-category1">Пиво, Сидр</span>
...
<div class="container">
    <ul class="breadcrumb">
       ...
       <li class="active" typeof="v:Breadcrumb">
          <span property="v:title"><h1>Пиво, сидр</h1></span>
       </li>
    </ul>
</div>
<div class="gap"></div>
    ...
    <div style="cursor: grab;" class="swiper-container swiper-container-horizontal" id="side_banners_slider">
       <div style="transform: translate3d(0px, 0px, 0px); transition-duration: 300ms;" class="swiper-wrapper">
          <div style="width: 263px; margin-right: 30px;" class="swiper-slide swiper-slide-active">
             <div class="banner_st"><a href="/msk/produkty_pitaniya/"><img src="<? the_theme_url(); ?>/img_adv/produkty_pitaniya.jpg" title="Продуктов питания"></a></div>
          </div>
	   </div>
    </div>
 </div>           
