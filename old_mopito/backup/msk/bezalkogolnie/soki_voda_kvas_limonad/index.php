...
$identifikator = 'soki_voda_kvas_limonad_msk';


$krepkie_count = fields_counter('alco_17',$identifikator)['count'];
$msk_count = fields_counter('alco_12','msk')['count'];
$alchg_msk = fields_counter('alco_33','soki_voda_kvas_limonad')['count'];
...
<html class="sb-init" lang="ru"><head>
   ...
   <title>Соки</title>
   <meta name="description" content="Мы нашли для Вас <? echo $krepkie_count; ?> видов соков и воды. mopito.ru - онлайн витрина для доставки безалкогольных напитков">	
   <link rel="canonical" href="http://mopito.ru/msk/bezalkogolnie/soki_voda_kvas_limonad">
...
<body class="wide" data-pagetype='_<? echo $identifikator; ?>'><!--pivo_sidr_medovuha_msk-->
...
<div class="header-container1">																
   <div class="box-header1">															
	  ...
	  <div class="header-item1 header-dropdown1"><span id="category_current" class="categoryCurrent header-category1">ВОда и соки</span>
...
<div class="container">
    <ul class="breadcrumb">
       ...
       <li typeof="v:Breadcrumb">
          <a href="/msk/alkogolnie/" rel="v:url" property="v:title" title="Перейти в категорию «Алкогольные напитки»">Вода и сок (<? echo $alchg_msk; ?>)</a>
       </li>
       <li class="active" typeof="v:Breadcrumb"></li>
       <li class="active" typeof="v:Breadcrumb">
          <span property="v:title"><h1>Безалкогольные напитки</h1></span>
       </li>
    </ul>
</div>
<div class="gap"></div>
...
<span class="hidden-xs">Чтобы купить воду или сок, а так же узнать цену, условия доставки, позвоните нам в ближайший к вам магазин</span>
      </div>																
...
<div class="col-xs-12">
   <div>
<h2>Сок в Воронеже</h2>
<p>	На нашей онлайн витрине бла бла бла...</p>
<h2>	Вода доставка		</h2>													
<p>	Мы предлагаем Вам найти себе любой на вкус воды бла бла бла ...</p>
   </div>																
   <div class="gap-small"></div>
            </div>
        </div>
...
<p class="desc"><img src="/img/logo_mopito_tauk.png"  width="100" alt="" title="Магазин алкотоваров" class="logo">Теперь у Вас есть возможность найти себе любимые напитки бла бла бла </p>
