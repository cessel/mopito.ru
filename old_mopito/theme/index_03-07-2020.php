...
<div class="container">
    <div class="cont-box">
        <h1>Mopito.ru - сервис поиска Поставщиков продуктов питания и напитков по Москве</h1>
            <div><p>Продуктовый портал Mopito.ru – место, где покупатели находят поставщиков по продуктам питания и напиткам онлайн. Мы являемся новым движением в качестве узконаправленного агрегатора услуг, на котором размещаются торговые представители от компаний, предлагающие свои товары и услуги. 
<br>
			<span class="">Основной приоритет нашей компании - это предоставить качественный сервис для магазинов и сегменту HoReCa, в поиске и выборе надежного поставщика товаров и услуг по продуктам питания и напиткам.</span></p>
            </div>
...
<!-- /menu_msk.пхп' -->
                ...
                <div class="swiper-container swiper-container-horizontal" id="side_banners_slider">
                    <div style="transform: translate3d(0px, 0px, 0px); transition-duration: 300ms;" class="swiper-wrapper">
                        <div style="margin-right: 30px;" class="swiper-slide swiper-slide-active">
                            <div class="banner_st"><a href="<?=''.$request_uri[1]."" ?>/produkty-pitaniya/"><img class="advbanleft" src="/img/dostavka_produkty_pitaniya.png" alt="Все поставщики продуктов питания оптом" title="Продукты питания оптом"></a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div style="height: 100%;" class="col-md-9 col-sm-12 stick_height_js">
            <div class="nav-tabs nav-stacked nav-coupon-category inbluetext">
                <span>Выберите нужного поставщика</span>
            </div>
...
<div class="ui-block ui-block_border-radius-4 old-search-form old-search-form_top">		
	...
	<div class="footer-rubricator">	
		<a href="/alkogolnie/"><span class="orangtext">Алкоголь оптом</span></a>
	</div>	
	...
	<div class="footer-rubricator">	
		<a href="/zakuski-sneki/"><span class="orangtext">Закуски оптом</span></a>
	</div>	
	<ul class="dropdown list-inline">	
		<li class="menu-li-bottm"><a href="/zakuski-sneki/zakuski-sneki-optom/"><span>Снеки оптом</span></a></li>
	</ul>	
	<div class="footer-rubricator">	
		<a href="/moloko-cheese-maslo/"><span class="orangtext">Молоко-Сыр-Масло оптом</span></a>
	</div>	
	<ul class="dropdown list-inline">	
	...
	<div class="footer-rubricator">	
		<a href="/myaso-optom/"><span class="orangtext">Мясо оптом</span></a>
	</div>	
	<ul class="dropdown list-inline">	
	...
	<div class="footer-rubricator">	
		<a href="/produkty-pitaniya/"><span class="orangtext">Продукты питания оптом</span></a>
	</div>	
	<ul class="dropdown list-inline">	
	...
	<div class="footer-rubricator">	
		<a href="/rybnaya-produkciya/"><span class="orangtext">Рыбная продукция оптом</span></a>
	</div>	
	<ul class="dropdown list-inline">	
    ...
    <div class="cont-box">
        <h2>МОПИТО РУ - продуктовый портал Поставщиков B2B</h2>
            <div>На сегодня мы лидеры в поисковой выдаче «Яндекса» по таким ключевым словам как «алкоголь оптом», «купить алкоголь оптом», «поставщики алкоголя». В ближайшей краткосрочной перспективе мы займем ведущие места в Гугле, а так же по таким направлениям напитков как водка, вино,  пиво, чай, кофе, по продуктам питания – мясо оптом, рыба, фрукты и овощи, оборудование для бизнеса, услугам кейтеринга и тп. Мы предоставляем возможность торговым представителям заработать на сервисе, бесплатно разместившись на портале МОПИТО РУ, а покупателям - найти достойного Поставщика!
<br>
            </div>
        <div class="gap-small"></div>
    </div>
...
<div class="ui-block ui-block_border-radius-4 old-search-form old-search-form_top">				
	<ul class="dropdown"></ul>			
	<div class="footer-rubricator-down">			
		<a href="/alkogolnie/"><span class="orangtext">Алкоголь оптом</span></a>		
	<ul class="dropdown nomrkr">			
		<li><a href="/alkogolnie/vodka-optom/"><span>Водка оптом</span></a></li>		
		<li><a href="/alkogolnie/konyak-optom/"><span>Коньяк оптом</span></a></li>		
		<li><a href="/alkogolnie/vino-optom/"><span>Вино оптом</span></a></li>		
		<li><a href="/alkogolnie/shampanskoe-optom/"><span>Шампанское оптом</span></a></li>		
...
<script src="/theme/js/ajax.js"></script>
	...
	<div class='age-modal hidden' content="noindex">
