...
<html class="sb-init" lang="ru"><head>
    ...
    <title>Техническая поддержка - для Поставщика - Как продлить срок публикации объявления</title>
          ...
          <ul class="topmenumob">
			...
			<div class="container">
					<ul class="breadcrumb">
						...
						<li typeof="v:Breadcrumb"><a href="#" rel="v:url" property="v:title" title="Раздел Поставщикам">Как продлить срок публикации объявления</a></li>
					</ul>
			</div>
	...
	<div style="height: 100%;" class="col-md-3 col-sm-3 hidden-xs hidden-sm stick_height_js">
		    <aside class="sidebar-left-help" id="sidebar-left-help">																
              <ul class="nav nav-tabs nav-stacked nav-coupon-category nav-coupon-category-left hidden-xs-block">
                 ...
                 <li class="active"><a href="/theme/help/postavshchikam/extend-period.php" title="Как продлить срок публикации объявления"><i class="fa"></i>Как продлить срок публикации объявления</a></li>
	...
	<div style="height: 100%;" class="col-md-9 col-sm-12 stick_height_js">
            <div class="row">
				<div class="cont-help-box">
					<div>
						<h1>Как продлить срок публикации объявления</h1>						
<p>Для продления актуальности объявления необходимо перейти на <a href="/theme/regpay/pay.php" target="_blank">«Продлить объявление»</a>, выбрать услугу <b>«Аренда»</b>, выбрать количество месяцев для указания периода показа объявления, далее <b>«Выставить счет»</b>, после чего на указанный при регистрации e-mail придёт сформированный счет для продления показа объявления. <br><br>
При оплате в поле <b>«комментарии»</b> необходимо указать <b>ID объявления</b> (форма имеет следующий, к примеру, вид: <b>ID1001-msk 24.06.2019 P-03</b>) для дальнейшей идентификации оплаты финансовой службой. Объявление обновляется после 00:00 часов по московскому времени.<br><br>
В случае отсутствия изменений в объявлении на странице с объявлением необходимо обновить кеш кнопкой <b>F5</b>, и при отсутствии изменений связаться с техподдержкой Мопито.ру. 
</p>
