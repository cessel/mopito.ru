...
if($_POST['form'] == 'profile'){
	...
	$multipart .= "\r\n";
		...
		<tr><td colspan=\"2\">*Это письмо сформировано автоматически, отвечать на него не нужно. В ближайшее время с Вами свяжется тех.поддержка. С уважением, команда МОПИТО.РУ</td></tr>";
