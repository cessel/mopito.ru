...
<html class="sb-init" lang="ru"><head>
    ...
    <title>Техническая поддержка - для покупателей найти поставщика</title>
          ...
          <ul class="topmenumob">
			...
			<div class="container">
					<ul class="breadcrumb">
						...
						<li typeof="v:Breadcrumb"><a href="#" rel="v:url" property="v:title" title="Перейти в раздел Покупателям">Покупателям</a></li>
					</ul>
			</div>
	...
	<div style="height: 100%;" class="col-md-3 col-sm-3 hidden-xs hidden-sm stick_height_js">
		    <aside class="sidebar-left-help" id="sidebar-left-help">																
              <ul class="nav nav-tabs nav-stacked nav-coupon-category nav-coupon-category-left hidden-xs-block">
                 <li class="active"><a href="/theme/help/pokupatelyam.php" title="Как найти поставщика"><i class="fa"></i>Как найти поставщика</a></li>
                 <li class="fa roadmach"><a href="/theme/help/pokupatelyam/hot-advt.php" title="Как найти горящие объявления"><i class="fa"></i>Как найти горящие объявления</a></li>
	...
	<div style="height: 100%;" class="col-md-9 col-sm-12 stick_height_js">
            <div class="row">
				<div class="cont-help-box">
					<div>
						<h1>Как найти поставщика в кафе бары магазины?</h1>
						<p>На Мопито.ру вы можете создать запрос на товары и услуги в интересующем вас городе. Поставщики сами будут предлагать варианты сотрудничества, а вам останется лишь выбрать лучший из них.</p>
						<h4>Как создать запрос на подбор товаров и услуг</h4>
						<p>1. Выберите интересуемый город, в котором необходимо найти Поставщика. <br>
2. Затем выберите нужную категорию товаров и услуг.<br>
3. Укажите тип нужного поставщика через фильтр, например производитель, поставщик или сетевая розница, запрос автоматически отфильтруется.<br>
4. Выберите нужное предложение и свяжитесь с ним напрямую. Мопито.ру для посетителей страницы не предполагает каких либо внесения предоплат для начала сотрудничества с представленными Поставщиками, все дальнейшие взаимоотношения посетителя и поставщика регулируются их договоренностями между собой. </p>
						<h4>Нужно ли вносить предоплату?</h4>
						<p>Для посетителей Мопито.ру ресурс бесплатный, который помогает найти нужного поставщика и категории товаров и услуг в своем городе. Для этого достаточно выбрать свой город и категорию товаров и услуг. </p>
