...
<html class="sb-init" lang="ru"><head>
    ...
    <title>Техническая поддержка - для Поставщика - как подать объявление</title>
          ...
          <ul class="topmenumob">
			...
			<div class="container">
					<ul class="breadcrumb">
						...
						<li typeof="v:Breadcrumb"><a href="#" rel="v:url" property="v:title" title="Перейти в раздел Покупателям">Поставщикам</a></li>
					</ul>
			</div>
	...
	<div style="height: 100%;" class="col-md-3 col-sm-3 hidden-xs hidden-sm stick_height_js">
		    <aside class="sidebar-left-help" id="sidebar-left-help">																
              <ul class="nav nav-tabs nav-stacked nav-coupon-category nav-coupon-category-left hidden-xs-block">
                 <li class="active"><a href="/theme/help/postavshchikam.php" title="Как подать объявление"><i class="fa"></i>Как подать объявление</a></li>
	...
	<div style="height: 100%;" class="col-md-9 col-sm-12 stick_height_js">
            <div class="row">
				<div class="cont-help-box">
					<div>
						<h1>Как подать объявление на Мопито.ру?</h1>
						<p>Зайдите на страницу <a href="/theme/regpay/reg.php" target="_blank">Подать объявление</a>, заполните профиль поставщика, затем выберите категорию и подкатегорию товаров и услуг, их характеристики и условия сотрудничества. После нажатия на <b>Отправить</b>, заполненная форма направляется модераторам на проверку, а Вам – копия заполненной формы о поставщике.  Размещение объявлений бесплатное. <br>
Ваше объявление появится на Мопито.ру после проверки модератором. Чтобы проверка прошла успешно, внимательно прочтите <a href="/theme/help/rules.php" target="_blank">Правила публикации </a>объявлений.<br>
Перед началом работы с сервисом также ознакомьтесь с <a href="/theme/help/agreements.php" target="_blank">Пользовательским соглашением </a>.
</p>
