...
<html class="sb-init" lang="ru"><head>
    ...
    <title>Техническая поддержка - для покупателей найти горящие объявления</title>
          ...
          <ul class="topmenumob">
			...
			<div class="container">
					<ul class="breadcrumb">
						...
						<li typeof="v:Breadcrumb"><a href="/theme/help/pokupatelyam.php" rel="v:url" property="v:title" title="Перейти в раздел Покупателям">Покупателям</a></li>						
						<li typeof="v:Breadcrumb"><a href=# rel="v:url" property="v:title" title="Перейти в раздел Покупателям">Как найти горящие объявления</a></li>
					</ul>
			</div>
	...
	<div style="height: 100%;" class="col-md-3 col-sm-3 hidden-xs hidden-sm stick_height_js">
		    <aside class="sidebar-left-help" id="sidebar-left-help">																
              <ul class="nav nav-tabs nav-stacked nav-coupon-category nav-coupon-category-left hidden-xs-block">
                 ...
                 <li class="active"><a href="/theme/help/pokupatelyam/hot-advt.php" title="Как найти горящие объявления"><i class="fa"></i>Как найти горящие объявления</a></li>
	...
	<div style="height: 100%;" class="col-md-9 col-sm-12 stick_height_js">
            <div class="row">
				<div class="cont-help-box">
					<div>
						<h1>Что такое горящие объявления?</h1>
						<p>Это предложение от Поставщика со скидкой на товар или услугу. Такие предложения показываются в общем списке. 
Горящие объявления выделены специальным значком и объявление выделено красной рамкой. </p>
						<h4>Как найти горящие объявления</h4>
						<p>Откройте список Поставщиков в нужном городе. Горящие предложения будут отмечены значком огонька. </p>
