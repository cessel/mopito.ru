                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <ul class="main_cities list-inline">
                                   ...
                                   <li><a href="<?='/'.$request_uri[1]."" ?>/alkogolnie/vodka_konyak_vino_shampanskoe_optom/"><span>Водка, коньяк, вино, шампанское</span></a></li>
                                   <li><a href="<?='/'.$request_uri[1]."" ?>/alkogolnie/pivo_sidr_medovuha_optom/"><span>Пиво, сидр, медовуха</span></a></li><br>
                                   <li><a href="<?='/'.$request_uri[1]."" ?>/bezalkogolnie/soki_voda_kvas_limonad_optom/"><span class="orangtext">Безалкоголь</span></a></li><br>
                                   <li><a href="<?='/'.$request_uri[1]."" ?>/zakuski_sneki/zakuski_sneki_optom/"><span class="orangtext">Закуски и снеки</span></a></li><br>
                                   <li><a href="<?='/'.$request_uri[1]."" ?>/kofe_chaj/chaj_kofe_optom/"><span class="orangtext">Чай и кофе</span></a></li><br>
                                   <li><a href="<?='/'.$request_uri[1]."" ?>/produkty_pitaniya/"><span class="orangtext">Продукты питания</span></a></li>
                                   <li><a href="<?='/'.$request_uri[1]."" ?>/produkty_pitaniya/frukty_ovoshchi_optom/"><span>Фрукты и овощи</span></a></li>
                                   <li><a href="<?='/'.$request_uri[1]."" ?>/produkty_pitaniya/myaso_myasnaya_produkciya_optom/"><span>Мясо и мясная продукция</span></a></li>
                                   <li><a href="<?='/'.$request_uri[1]."" ?>/produkty_pitaniya/ryba_moreprodukty_optom/"><span>Рыба и морепродукты</span></a></li><br>
                                   <li><a href="<?='/'.$request_uri[1]."" ?>/oborudovanie/"><span class="orangtext">Оборудование</span></a></li>
                                   ...
                                   <li><a href="<?='/'.$request_uri[1]."" ?>/catering/vyezdnoe_obsluzhivanie_bankety_organizaciya_prazdnikov/"><span class="orangtext">Выездное обслуживание, Банкеты, Организация праздников</span></a></li><br>
                                   <li><a href="<?='/'.$request_uri[1]."" ?>/uslugi/otdelka_i_montazh/"><span class="orangtext">Монтаж и отделка</span></a></li><br>
                               </ul>
							</div>
                        </div>
                    </div>
